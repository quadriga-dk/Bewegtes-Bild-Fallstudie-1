...
:class: lernziele
**Datenkompetenzen**
* Systematische Erfassung filmanalytischer Primärdaten
* Strukturierte Organisation temporaler Metadaten
* Kategorisierung audiovisueller Gestaltungsmittel
...
```
```{admonition} Lernmodul B: Freitextannotation mit digitalen Tools (*optional*)
:class: lernziele
**Datenkompetenzen**
* Anwendung spezialisierter Annotationssoftware
* Digitale Erfassung semantisch strukturierter Bewegtbilddaten
* Auswertung der Annotationsdaten und Vergleich der methodischen Herangehensweise
...
```
```{admonition} Lernmodul C: Semantic Web und Filmontologie
:class: lernziele
**Datenkompetenzen**
* Verständnis ontologischer Datenstrukturen nach Semantic Web Prinzipien
* Übertragung filmanalytischer Termini in eine hierarchische Datenstruktur semantischer Triple
* Anwendung der Ontologie zur Klassifizierung affektrhetorischer Gestaltungsmittel
...
```
```{admonition} Lernmodul D: Annotieren mit einer Filmontologie
:class: lernziele
**Datenkompetenzen**
* Anwendung spezialisierter Annotationssoftware unter Miteinbeziehung einer Filmontologie
* Präzise ontologiebasierte Erstellung und Bereinigung von Annotationsdaten 
* Kritische Reflektion datenspezifischer Methoden und Anwendbarkeiten 
...
```
```{admonition} Lernmodul E: Datenvisualisierung und -interpretation
:class: lernziele
**Datenkompetenzen**
* Syntaxbasierte Konfiguration von Visualisierungsparametern
* Exploration komplexer Annotationsdatensätze
* Visuelle Darstellung temporaler und multimodaler Verlaufsdynamiken sowie Aufbereitung der Datenstrukturen für die wissenschaftliche Weiterverarbeitung
