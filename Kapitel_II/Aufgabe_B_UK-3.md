...
:::{dropdown} Antwort
Da wir bei einigen Typen je Einstellung annotieren, müssen wir natürlich nicht jedes Mal die Einstellungsgrenzen neu setzen. Hierfür reicht es, wenn wir die Annotationssegmentierung aus dem Typen Einstellungsnummer in jene andere Typen kopieren, die wir auch nach diesem Schema annotieren möchten. 
:::
```{hint} 
